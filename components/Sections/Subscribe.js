...
const url =
  "https://USERNAME.SERVER.list-manage.com/subscribe/post-json?u=USER_ID&id=AUDIENCE_ID";
...
const Subscribe = () => {
  ...
  return (
    <section
      id="subscribe"
      className="parallax"
      data-image="/Sample/sample9_1920x800.jpg"
      ref={parallax}
    >
      {/* <!-- Overlay --> */}
        ...
        <Row className="justify-content-center">
          <Col className="col-12 col-md-10 col-lg-6">
            <div className="section-title text-center white">
              ...
              <p>
                Vivamus ornare feugiat orci eu faucibus. Phasellus nulla arcu,
                pharetra nec laoreet in, scelerisque a lectus.
              </p>
            </div>
          </Col>
        </Row>
