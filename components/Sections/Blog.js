          ...
          <Col className="col-12 col-md-10 col-lg-6">
            <div className="section-title text-center">
              ...
              <p>
                ...
                posuere ipsum dolor sit amet, consectetur elit.
              </p>
            </div>
          </Col>
        </Row>
          ...
          <Col className="col-12 col-lg-4 res-margin">
            <div className="blog-col">
              <p>
                <a href="/blog-post">
                  <img
                    src="/Sample/sample8_1200x800.jpg"
                    className="blog-img"
                    alt=""
                  />
                </a>
              ...
              <div className="blog-wrapper">
                <div className="blog-text">
                  ...
                  <p>
                    Quisque dui at erat auctor pulvinar nisl felis, gravida et
                    aliquam vitae, aliquet quis nibh.
                    <a href="/blog-post" className="btn-read-more">
                      Read More
                    </a>
                  </p>
                </div>
