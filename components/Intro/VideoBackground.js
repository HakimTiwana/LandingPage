          ...
          <Col className="col-12 col-lg-6 offset-lg-3">
            ...
            <div className="banner-text text-center">
              ...
              >
                <a
                  href="#"
                  className="d-inline-flex align-items-center m-2 m-sm-0 me-sm-3"
                >
                  <img src="/Sample/googlePlay_200x60.png" alt="" />
                </a>

                <a
                  href="#"
                  className="d-inline-flex align-items-center m-2 m-sm-0"
                >
                  <img src="/Sample/appleStore_200x60.png" alt="" />
                </a>
              </div>
            </div>
